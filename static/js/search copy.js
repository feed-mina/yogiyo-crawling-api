...
function whereami(elt) {
    ...
    function success(pos) {
      ...
      async function  Search_Category(Search, page, lat, lng){
        const yogiyoUrl = `http://127.0.0.1/Search`
 ...
 //const yogiyoUrl = `http://127.0.0.1/Search/?items=60&lat=37.4669312&lng=126.943232&order=rank&page=0&search=김밥`
...
item.appendChild('name');
     ...
     Search_Category().then(json => initialize(json));
     Search_Category()
  ...
  function initialize(products) {
    ...
    function showProduct(blob, product) {
      ...
      section.appendChild(para_delivery);
