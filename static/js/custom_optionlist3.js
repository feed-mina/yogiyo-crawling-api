...
window.sessionStorage.setItem('spantotalsum', spantotalsum);

window.sessionStorage.setItem('price', price);
window.sessionStorage.setItem('menu',spantotalname);
window.sessionStorage.setItem('menu1',checkboxname);
window.sessionStorage.setItem('radioname',radioname);
window.sessionStorage.setItem('checkboxname',checkboxname);
window.sessionStorage.setItem('radiototal',radiototal);
window.sessionStorage.setItem('checkboxtotal',checkboxtotal);
   ...
   console.log(group);
   window.sessionStorage.setItem('foodname',name);
...
reviewgobutton.appendChild(goreviewdiv);
 ...
 //console.log(divfoodimg.src);
const stoargefoodimg = window.sessionStorage.setItem('storagefoodimg',divfoodimg.src);
