...
var reviewitemname = '';
    for (let v = 0; v < itemstr.length; v++) {
      reviewitemname=   reviewitemname= + itemstr.indexOf(v);
      let review_images_name = json.menu_items[v].name;
      let ids = json.menu_items[v].id;
      //    console.log(json.menu_items[v])
      console.log(ids);
      console.log(reviewitemname)
      console.log(review_images_name);
   //   Find_Id_Photo(parse_Lode_json,ids);
      reviewdiv3.textContent += `${review_images_name}`;
...
//console.log(json.menu_items[0].name);
  ...
  // console.log(parse_Lode_json[i].items)
        ...
        //console.log(parse_Lode_json[i].items.length)
          for(let v = 0; v<parse_Lode_json[i].items[v].length; v++){
        //   console.log(parse_Lode_json[i].items[v].id)
     //      console.log(id)
     console.log(parse_Lode_json[i].items[v].original_image)
            if(parse_Lode_json[i].items[v].id ==  id){
              const menuphotosrc = parse_Lode_json[i].items[v].image
              console.log(parse_Lode_json[i].items[v].original_image)
              console.log(menuphotosrc);
      if(menuphotosrc !== undefined){
