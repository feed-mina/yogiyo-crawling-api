...
function initialize(dataset) {
    ...
    function showGroup(optiongroup) {
        ...
        function btn_check() {
            ...
            window.sessionStorage.setItem('name', spantotalsum);
    ...
    window.localStorage.setItem('foodprice', price);
    ...
    const checkoption2 = document.createElement('input');
    checkoption2.setAttribute('class', 'checkoption2');
    const gobasketbutton2 = document.createElement('div');
    const gobaskethref2 = document.createElement('a');
    gobaskethref2.setAttribute('href', 'http://127.0.0.1:5000/6');
    gobaskethref2.setAttribute('class', 'gobaskethref2');
    ...
    function btn_check2() {
        ...
        checkoption2.setAttribute('type', 'button');

        gobasketbutton2.onclick = function () {
            let totalsum = 0;
            let totalcount = 0;
            let checkboxtotal = 0;
            let checkboxcount = 0;
        ...
        downbutton.setAttribute('type', 'button');
        downbutton.setAttribute('class', 'downbutton');
        changenum.setAttribute('class','changenum');
        priceupdown.appendChild(changenum);
        changenum.appendChild(upbutton);
        changenum.appendChild(resultElement);
        changenum.appendChild(downbutton);
    ...
    const gobasket = document.querySelector('gobasket')
    gobasket.setAttribute('class', 'gobasket');
    gobasket.appendChild(checkoption2);
    gobaskethref2.setAttribute('href', 'http://127.0.0.1:5000/6');
    gobaskethref2.setAttribute('class', 'gobaskethref2');
    gobasketbutton2.setAttribute('class', 'gobasketbutton2');

   gobasket.appendChild(gobaskethref2);
//   gobaskethref2.appendChild(gobasketbutton2);
